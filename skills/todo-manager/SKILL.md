...
2. Detect ticket ID from context:
   - Check if user is working on a task file (e.g., `task-history/cspm/PROJ-123-gcp-org-onboarding.md`)
...
### 📌 Pending (1)
- **[cspm]** Test with customer environment `⚡ medium` `#user`
...
```
📄 Task file: task-history/cspm/PROJ-123-gcp-org-onboarding-issues.md
```
